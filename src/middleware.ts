...
export const middleware = async(req: NextRequest)=>{
    ...
    const protectedRoutes = ['/authonly', '/watch']
    ...
    //$ The middleware rewrites it internally to /watch/movie, but it never sends a redirect status (like 302 or 307).

    //$ The browser receives the HTML/CSS/JS from /watch/movie, but still sees / in the address bar.
